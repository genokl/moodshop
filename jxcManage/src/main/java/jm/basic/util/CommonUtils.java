...
import jm.frameWork.util.MyX509TrustManager;
...
//		 * @return
//		 */
//		public static String getConsumeCourseGroup(List<ConsumeCourse> list) {
//			if(list!=null&&list.size()>0){
//				String courseNameS="";
//				String  courseGroupName=list.get(0).getCourseLevelStr();
//				ArrayList<ConsumeCourse> aa=new ArrayList<>();
//				net.sf.json.JSONObject jo=new net.sf.json.JSONObject();
//				for (int i = 0; i < list.size(); i++) {
//					ConsumeCourse course = list.get(i);
//					String itemName=course.getCourseLevelStr();
//					if(itemName.equals(courseGroupName)){//本组的
//						aa.add(course);
//					}else {//下一组的第一个
//						jo.put(courseGroupName, aa);
//						courseNameS+=courseGroupName+",";
//						aa.clear();
//						//放入下一组的信息
//						courseGroupName=itemName;
//						aa.add(course);
//					}
//				}
//				jo.put(courseGroupName, aa);
//				courseNameS+=courseGroupName+",";
//				jo.put("courseNameS", courseNameS);
