...
<div class="top-content">
    <h2 class="p0 m0 white l ml20 logo_color" style="margin-top: 19px; font-size: 23px;">中公远通进销存管理系统</h2>
    <div class="r pr30">
...
$(function(){
	//退出方法
	$("#exit").click(function(){
		 $.get("/login/userlogOut.do",function(data){
			 console.log(data)
			top.window.location.href=$("#basePath").val()+"jump/topage.do?pagePath=page&pageName=login";
		},"json"); 
	});
});
